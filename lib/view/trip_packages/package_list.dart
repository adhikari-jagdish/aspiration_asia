          ...
          children: [
            Stack(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: Integers.SIZE_TEN, vertical: Integers.SIZE_TEN),
                  child: Row(
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: (){
                      Navigator.pushNamed(context, RouteConstants.routePackageDetails);
                    },
                    child: Container(
                      width: context.widthPx,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Text(
                                        ...
                                        style: CustomStyle.blackTextBold18.copyWith(fontSize: 30.ssp),
                                        maxLines: 2,
                                    ...
                                    Column(
                                      children: [
                                        Text('\$120', style: CustomStyle.blackTextBold18.copyWith(fontSize: 28.ssp)),
                                        SizedBox(
                                          height: 3.0,
                                        ),
                                        Text('\₹8999', style: CustomStyle.blackTextBold18.copyWith(fontSize: 28.ssp)),
                                        SizedBox(
                                          height: 3.0,
                                        ),
                                        Text(
                                          'Per Person',
                                          style: CustomStyle.blackTextSemiBold18.copyWith(color: Colors.grey, fontSize: 20.ssp),
                                        ),
                                      ],
                                    )
                                  ],
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text('Transport', style: CustomStyle.blackTextSemiBold18.copyWith(fontSize: 26.ssp)),
                                    )
                                  ],
                                )
                              ],
